...
#define FFMPEG_CONFIGURATION "--prefix=/usr/local/ffmpeg --enable-libfreetype --enable-libfontconfig --enable-libfribidi --enable-gpl --enable-libass --enable-libx264"
#define FFMPEG_LICENSE "GPL version 2 or later"
#define CONFIG_THIS_YEAR 2017
#define FFMPEG_DATADIR "/usr/local/ffmpeg/share/ffmpeg"
#define AVCONV_DATADIR "/usr/local/ffmpeg/share/ffmpeg"
#define CC_IDENT "gcc 4.8.5 (GCC) 20150623 (Red Hat 4.8.5-16)"
