...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--prefix=/usr/local/ffmpeg --enable-libfreetype --enable-libfontconfig --enable-libfribidi --enable-gpl --enable-libass --enable-libx264
...
CFLAGS=   -std=c11 -fomit-frame-pointer -pthread -I/usr/local/ass/include -I/usr/local/fontconfig/include -I/usr/local/freetype2/include/freetype2 -I/usr/local/fribidi/include/fribidi -I/usr/local/fontconfig/include -I/usr/local/freetype2/include/freetype2 -I/usr/local/freetype2/include/freetype2 -I/usr/local/fribidi/include/fribidi -I/usr/local/include  -g -Wdeclaration-after-statement -Wall -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wwrite-strings -Wtype-limits -Wundef -Wmissing-prototypes -Wno-pointer-to-int-cast -Wstrict-prototypes -Wempty-body -Wno-parentheses -Wno-switch -Wno-format-zero-length -Wno-pointer-sign -O3 -fno-math-errno -fno-signed-zeros -fno-tree-vectorize -Werror=format-security -Werror=implicit-function-declaration -Werror=missing-prototypes -Werror=return-type -Werror=vla -Wformat -fdiagnostics-color=auto -Wno-maybe-uninitialized
...
EXTRALIBS=-L/usr/local/ass/lib -lass -lxcb -lxcb-shm -lxcb-xfixes -lxcb-shape -lasound -L/usr/local/lib -lx264 -L/usr/local/fribidi/lib -lfribidi -L/usr/local/freetype2/lib -lfreetype -L/usr/local/fontconfig/lib -L/usr/local/freetype2/lib -lfontconfig -lfreetype -L/usr/local/ass/lib -lass -lm -ldl -llzma -lz -pthread -pthread 
COMPAT_OBJS=
INSTALL=install
LIBTARGET=
